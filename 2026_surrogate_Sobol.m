...
ddata1=forward(net, dlarray(TestData3, 'BC'));
var(:,1)=extractdata(ddata1);%(:,4);
ddata1=forward(net, dlarray(TestData4, 'BC'));
var(:,2)=extractdata(ddata1);;%(:,4);
ddata1=forward(net, dlarray(TestData5, 'BC'));
var(:,3)=extractdata(ddata1);;%(:,4);
ddata1=forward(net, dlarray(TestData6, 'BC'));
var(:,4)=extractdata(ddata1);;%(:,4);
ddata1=forward(net, dlarray(TestData7, 'BC'));
var(:,5)=extractdata(ddata1);;%(:,4);
ddata1=forward(net, dlarray(TestData8, 'BC'));
var(:,6)=extractdata(ddata1);;%(:,4);
ddata1=forward(net, dlarray(TestData9, 'BC'));
var(:,7)=extractdata(ddata1);;%(:,4);
ddata1=forward(net, dlarray(TestData10, 'BC'));
var(:,8)=extractdata(ddata1);;%(:,4);
ddata1=forward(net, dlarray(TestData11, 'BC'));
var(:,9)=extractdata(ddata1);;%(:,4);
ddata1=forward(net, dlarray(TestData12, 'BC'));
